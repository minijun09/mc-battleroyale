...
scoreboard objectives add revolver_max_ammo dummy
scoreboard objectives add revolver_ammo dummy

scoreboard objectives add m4a1_cooldown dummy
scoreboard objectives add m4a1_max_ammo dummy
scoreboard objectives add m4a1_ammo dummy