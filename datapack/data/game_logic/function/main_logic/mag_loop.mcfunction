...
execute as @a if items entity @s weapon.offhand *[custom_data~{gun_id:"revolver"}] run function game_logic:main_logic/revolver/revolver_reload
...
execute as @a if items entity @s weapon.offhand *[custom_data~{gun_id:"m4a1"}] run function game_logic:main_logic/m4a1/m4a1_reload
