# 1. 마커 소환
summon block_display ~ ~ ~ {Tags:["bullet","new_bullet"],block_state:{Name:"minecraft:stone"},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.01f,0.01f,0.01f]}}
